...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="active">Agregar nuevas opciones</li>
        </ol>
        <div class="well col-md-8 col-md-offset-2">
            @if($errors->any())
                <div class="alert alert-danger">
                    <span>Por favor llenar los campos vacios</span>
                </div>
            @endif
            <form method="POST" action=" {{ route('poll.options.add', $poll->id) }}">
                ...
                <div class="form-group">
                    <ul id="options">
                        <li>
                            <input type="text" name="options[0]" class="form-control add-input" placeholder="escriba su opcion" />
                ...
                <!-- Create Form Submit -->
                <div class="form-group">
                    <input name="Add" type="submit" value="Agregar" class="btn btn-primary create-btn" >
                </div>
            </form>
        </div>
    </div>
